<div class="content-wrapper">
    <link rel="shortcut icon" href="./assets/gambar/Kepala Rubo.png">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($this->session->userdata('level') == 'Administrator') {  ?>
                                            ...
                                            <a href="<?= base_url('admin/ruangan/delete/') . $row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Account tidak bisa dipulihkan setelah dihapus">
