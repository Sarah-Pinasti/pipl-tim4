                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($this->session->userdata('level') == 'Administrator') { ?>
                                            ...
                                            <?php } ?>
                                        <?php } ?>
                                        <?php if ($row['status'] == 'Diterima' && !empty($row['idBarang']) && $row['jumlah'] > 0) { ?>
                                            <a href="<?= base_url('admin/booking/kembalikan/') . $row['id'] ?>" class="btn btn-warning btn-xs tombol-yakin" data-isidata="Mengembalikan barang akan dikembalikan">
                                                <div class="fa fa-rotate-left "></div> Kembalikan Barang
                                            </a>
                                        <?php } ?>

                                        <?php if ($row['surat'] != 'Tidak Ada' && !empty($row['file'])) { ?>
                                            <a href="<?= base_url('admin/booking/view_pdf/') . $row['file']; ?>" target="_blank" class="btn btn-primary" data-isidata="Surat Tidak Tersedia">
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('admin/booking/insert'); ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Barang</label>
                    <select name="idBarang" class="select2" style="width: 100%">
