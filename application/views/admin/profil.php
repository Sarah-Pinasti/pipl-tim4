                        ...
                        <div class="active tab-pane" id="account">
                            <form class="form-horizontal" action="<?= base_url('admin/profil/update/') . $this->session->userdata('id') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="jenisKelamin" class="form-control" required>
                                                <option value="Laki-Laki" <?= ($this->session->userdata('jenisKelamin') == 'Laki-Laki') ? 'selected' : '' ?>>
                                                    Laki-Laki</option>
                                                <option value="Perempuan" <?= ($this->session->userdata('jenisKelamin') == 'Perempuan') ? 'selected' : '' ?>>
                                                    Perempuan</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">New Password <font color="red">*)</font>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="skin" class="form-control" required>
                                                <option value="<?= $this->session->userdata('skin') ?>" selected>
                                                    <?= $this->session->userdata('skin') ?></option>
