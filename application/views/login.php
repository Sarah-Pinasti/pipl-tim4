...
<head>
  ...
  <link rel="shortcut icon" href="./assets/logo/Logo-1720963088.png">
...
<body class="hold-transition login-page" style="background-color: #A0DEFF">
  <div class="login-box">
    <div class="login-logo">
      <?php foreach ($aplikasi->result_array() as $row) { ?>
        <center><img src="<?= base_url('assets/logo/') . $row['logo'] ?>" alt="" class="img-responsive" width="30%" style="margin-bottom: 30px"></center>
        <a href="<?= base_url('home') ?>"><b><?= $row['nama'] ?></b></a>
      <?php } ?>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body" style="background-color: #CAF4FF">
      <div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('pesan') ?>"></div>
      <p class="login-box-msg">Masukkan username dan password</p>

      <p> Belum Punya akun? <br>
        Silahkan Hubungi Administrator<br>
      </p>
